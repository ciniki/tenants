...
//                    'fixhistory':{'label':'Fix History', 'fn':'M.ciniki_tenants_settings.fixallhistory();'},
                    ...
                    'ifbupgrade':{'label':'IFB Upgrade', 
                        'visible':function() { return M.modFlagSet('ciniki.customers', 0x01); },
                        'fn':'M.startApp(\'ciniki.customers.ifbupgrade\', null, \'M.ciniki_tenants_settings.menu.show();\');',
                        },
                    'convertMembersOnly':{'label':'Convert Members Only -> Web', 
                        'visible':function() { return M.modOn('ciniki.membersonly') ? 'yes' : 'no'; },
                        'fn':'M.startApp(\'ciniki.membersonly.convertweb\', null, \'M.ciniki_tenants_settings.menu.show();\');',
                        },
