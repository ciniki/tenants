...
// </details>
//
function ciniki_tenants_cacheDir(&$ciniki, $tnid) {
    ...
    elseif( $tnid > 0 ) {
        ...
        if( !isset($rc['tenant']) ) {
            return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.tenants.10', 'msg'=>'Unable to get tenant details'));
        }
        ...
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.tenants.11', 'msg'=>'Unable to get tenant cache directory'));
    }
