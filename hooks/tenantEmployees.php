...
// -------
//
function ciniki_tenants_hooks_tenantEmployees(&$ciniki, $tnid, $args) {
    ...
    $strsql = "SELECT ciniki_tenant_users.user_id, "
        ...
        . "AND ciniki_tenant_users.permission_group IN ('owners', 'employees') "
        . "AND ciniki_tenant_users.status = 10 "      // Active employees only
        . "AND ciniki_tenant_users.user_id = ciniki_users.id "
        . "AND ciniki_users.status < 11 "
        . "ORDER BY ciniki_users.display_name "
        . "";
