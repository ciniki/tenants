...
// -------
//
function ciniki_tenants_reportModules($ciniki) {
    //
    ...
    $ac = ciniki_tenants_checkAccess($ciniki, 0, 'ciniki.tenants.reportModules');
    if( $ac['stat'] != 'ok' ) {
        return $ac;
    }
    ...
    $strsql = "SELECT "
        ...
        . "LEFT JOIN ciniki_tenants ON (ciniki_tenant_modules.tnid = ciniki_tenants.id "
